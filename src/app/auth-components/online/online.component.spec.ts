...
describe('OnlineComponent', () => {
    ...
    describe('Deferrable views', () => {
      ...
      describe('app-register', () => {
        ...
        it('should call authStateService.rememberMe() when rememberMe event was emitted', () => {
          registerComponent.triggerEventHandler('rememberMe', true);
      ...
      describe('app-login', () => {
        ...
        beforeEach(async () => {
          ...
          await deferBlockFixture.render(DeferBlockState.Complete);
          loginComponent = fixture.debugElement.query(By.css('app-login'));
        });

        it('should be rendered when register is "false"', async () => {
  ...
  describe('_checkParamMap()', () => {
    it('should set component.register to false if pathElement is "force=login"', () => {
      ...
      (component as any)._checkParamMap();
